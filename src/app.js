...
Ammo().then((Ammo) => {
  ...
  // 创建你的信息栏 (liuziyi artist website)
  ...
  function loadRyanText() {
    ...
    text_loader.load('./src/jsm/Poppins_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry("Liuziyi", {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
  ...
  function loadEngineerText() {
    ...
    text_loader.load('./src/jsm/Poppins_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('artist website', {
        font: font,
        size: 1.5,
        height: 0.5,
        curveSegments: 20,
  ...
  function start() {
    ...
    createBox(
      ...
      boxTexture.mana,
      URL.mana,
      'https://www.manamana.net/peopleCenter/2422924/home#!zh',
      0x000000,
      true
    );
    ...
    createBox(
      ...
      boxTexture.BiliBili,
      URL.BiliBili,
      'https://space.bilibili.com/168836189?spm_id_from=333.999.0.0',
      0x000000,
      false
    );
    ...
    // 浮动文字
    floatingLabel(11.875, 4.5, -70, 'mana');
    ...
    allSkillsSection(9, 0.01, 45, 25, 25, boxTexture.edmText);
    ...
    // 板块文字
    simpleText(-50, 0.01, -5, 'Good software', 3);
    simpleText(-42, 0.01, -30, 'Work or project ', 3);
    simpleText(0, 0.01, -15, 'Welcome :)', 6);
